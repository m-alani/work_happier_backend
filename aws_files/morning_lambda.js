// Playing around with 'LaunchRequest' and 'IntentRequest'
  ...
  try {
    ...
    switch (event.request.type) {
      ...
      case "LaunchRequest":
        ...
        context.succeed(
          generateResponse(
            buildSpeechletResponse("You're swiped-in, Marwan. How are you doing this morning?", false),
            {}
          )
        )
        break;
      ...
      case "IntentRequest":
        ...
        switch(event.request.intent.name) {
            case "MorningGreeting":
                context.succeed(
                  generateResponse(
                    buildSpeechletResponse(`He's doing great! What about you?`, true),
                    {}
                  )
                )
            break;
